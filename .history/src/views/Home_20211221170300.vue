    ...
    <div class="content">
      ...
      <div>
        <el-table :data="arr" border style="width: 100%" >
          ...
          <el-table-column prop="contact" label="联系方式" header-align='center'> </el-table-column>
          <el-table-column prop="mailbox" label="邮箱" header-align='center'> </el-table-column>
