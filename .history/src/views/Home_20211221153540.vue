    ...
    return {
      ...
      rules: {
        ...
        contact: [
          ...
          {pattern:/^(?:(?:\+|00)86)?1(?:(?:3[\d])|(?:4[5-79])|(?:5[0-35-9])|(?:6[5-7])|(?:7[0-8])|(?:8[\d])|(?:9[189]))\d{8}$/, message: "输入的手机号码有误",  trigger: "blur" },
        ],
        mailbox: [
          { required: true, message: "请输入邮箱", trigger: "blur" },
            { pattern:/^(([^<>()[\]\\.,;:\s@"]+(\.[^<>()[\]\\.,;:\s@"]+)*)|(".+"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/, message: "长度在 1 到 5 个字符", trigger: "blur" },
        ],
